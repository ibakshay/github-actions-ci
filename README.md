...
When we navitage to GitHub Actions tab, the GitHub will itself recommend the appropriate  Workflows for the repository. You can either choose one of the recommended workflows or setup a workflow yourself. 
